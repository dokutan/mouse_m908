...
int mouse_m990chroma::dump_settings( std::ostream& output ){
...
int mouse_m990chroma::read_and_print_settings( std::ostream& output ){
...
int mouse_m990chroma::read_settings(){
